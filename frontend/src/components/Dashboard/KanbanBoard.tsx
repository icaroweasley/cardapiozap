    ...
    <div className="flex-1 flex flex-col h-full bg-white/40 dark:bg-black/40 backdrop-blur-3xl border border-black/10 dark:border-white/10 shadow-2xl overflow-hidden animate-fade-up rounded-3xl lg:m-2">
      ...
      <div className="flex-1 overflow-x-auto p-6 hide-scrollbar">
        <div className="flex gap-6 h-full min-w-max">
          {COLUMNS.map(column => (
            <div key={column.id} className="w-[320px] flex flex-col bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 h-full backdrop-blur-md rounded-2xl overflow-hidden">
